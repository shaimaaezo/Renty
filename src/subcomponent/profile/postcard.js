import postImg from '../../imgs/p1.jpg'
        ...
        return ( 
            <div className="posts-wrapper">
                <div className="d-block d-md-flex listing-horizontal">
                    <img className="img d-block post-img" src={postImg} alt="" />
                    ...
                    <div className="post-content align-self-center pl-4 pt-4 pb-4 pr-4">
                        ...
                        <div className="container text-end">
                            <span><Link to={`/profile/${this.props.posts.userID}/details/${this.props.posts._id}`} className="details-btn btn btn-outline mt-3">View Details <i className="bi bi-arrow-right"></i></Link></span>
                        </div>
                    </div>
                </div>
            </div>
